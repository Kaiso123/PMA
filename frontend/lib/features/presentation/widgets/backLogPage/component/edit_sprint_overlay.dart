...
OverlayEntry createEditSprintOverlayEntry(
  ...
  final ValueNotifier<String> currentName = ValueNotifier(sprint.name);
  final ValueNotifier<String> currentDescription = ValueNotifier(sprint.description ?? '');
  final ValueNotifier<String> currentStatus = ValueNotifier(sprint.status);
  final ValueNotifier<String> currentPriority = ValueNotifier(sprint.priority);
  final ValueNotifier<String> currentCreated = ValueNotifier(sprint.created.toIso8601String());
  final ValueNotifier<String> currentEndTime = ValueNotifier(sprint.endTime?.toIso8601String() ?? '');
  final ValueNotifier<DateTime> selectedCreatedDate = ValueNotifier(sprint.created);
  final ValueNotifier<DateTime> selectedEndDate = ValueNotifier(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            print('Updating sprint: $updatedSprint');
